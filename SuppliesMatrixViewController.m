//
//  SuppliesMatrixViewController.m
//  LexColor-native
//
...
@interface SuppliesMatrixViewController ()

@end

@implementation SuppliesMatrixViewController
@synthesize _suppliesMatrixItems;
...
- (void)viewDidLoad
{
    ...
    titleLabel.text = @"Supplies Matrix";
    ...
    for (Data *item in _suppliesMatrixItems) {
